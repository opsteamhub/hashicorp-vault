...
| <a name="subnet_private_id"></a> [subnet_private_id](#input\_subnet\_private\_id) | Utilizado se for utilizar uma subnet já existente quando é definido `false` na variavel `create_replica`. | `bool` | `true` | no |
